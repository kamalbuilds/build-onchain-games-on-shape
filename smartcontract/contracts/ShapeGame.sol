...
contract ShapeGame is Ownable {
    ...
    event ShapeGamePurchased(address indexed player, address playerContract);
    ...
    function buyGame() external payable {
        ...
        ShapeGamePlayerStatus playerContract = new ShapeGamePlayerStatus(tasks);
        players[msg.sender] = address(playerContract);
        playerAddresses.push(msg.sender);
        emit ShapeGamePurchased(msg.sender, address(playerContract));
    }
